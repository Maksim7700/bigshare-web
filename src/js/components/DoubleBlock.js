...
const DoubleBlock = (props) => {
    return (
        <div className='main__dobule__block d-flex em-05 l-h-24'>
            <div className='double__middle_block'>
                ...
                <div className='double__block__text f-w-300 p-block'>{props.text1}</div>
            </div>
            <div className='double__middle_block__2'>
                ...
                <div className='double__block__text f-w-300 p-block'>{props.text2}</div></div>
        </div>
    );
}
