        ...
        <div className='footer em-5'>
            <header className='header'>
                ...
                <Navigate className='nav footer-2'><div aria-current="page">
                    ...
                    <ul className="nav-list">
                        <li className="nav-list__item em-05"><Link className="nav-list__link c-8" to={'/about'}>Terms of Use</Link></li>
                        <li className="nav-list__item em-05"><Link className="nav-list__link c-8" to={'/portfolio'}>Privacy Policy</Link>
                        </li>
                    </ul>
                    <ul className='nav-list'>
                        <li><img className='social' src={process.env.PUBLIC_URL + '/email.svg'}
                            alt="linked-in" /></li><span className='email'>bigshare@gmail.com</span>
                    </ul>
                </Navigate>
