...
const Anketa = () => {
  ...
  return (
    <Container>
      <div className='paddint-top-200 padding-bottom-24 f-w-700 gilroy l-h-72 f-s-56 center Gilroy-700-bold'><span className='text-color-black'>Let's </span><span className='big-share-color'>get started</span><span className='text-color-black'>. Tell us how we can help</span></div>
