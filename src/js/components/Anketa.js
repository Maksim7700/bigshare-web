...
const Anketa = () => {
  ...
  return (
    <Container>
      ...
      <div id='anketa' className='padding-top-100 padding-bottom-24 f-w-700 gilroy l-h-72 f-s-56 center Gilroy-700'><span className='text-color-black'>Let's </span><span className='big-share-color'>get started</span><span className='text-color-black'>. Tell us how we can help</span></div>
